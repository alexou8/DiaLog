...
const QUALITY_OPTIONS: { value: '1' | '2' | '3' | '4' | '5'; label: string; description: string }[] = [
  ...
  return (
    <form action={action} noValidate>
      ...
      <Field label="Wake time" required error={state?.errors?.endedAt} htmlFor="endedAt">
        {({ id, describedBy, invalid }) => (
          <TextInput id={id} name="endedAt" type="datetime-local" required defaultValue={now} aria-describedby={describedBy} invalid={invalid} />
        )}
      </Field>

      <RadioCards name="quality" legend="Sleep quality" hint="How rested did you feel?" options={QUALITY_OPTIONS} columns={1} />
