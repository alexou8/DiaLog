...
import { DEMO_EMAIL, DEMO_PASSWORD, TEST_PASSWORD, completeOnboarding, signIn, signOut, uniqueEmail } from './helpers';

test.describe('sign up and onboarding', () => {
  test('sign up, onboard, land on dashboard, sign out, sign back in, see own data', async ({ page }) => {
